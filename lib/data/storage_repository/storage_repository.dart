...
class StorageRepository {
  ...
  static Future<bool>? deleteInt({required String key}){
    debugPrint("Deleting...");
  ...
  static Future<bool>? deleteString({required String key}) {
    debugPrint("Deleting...");
    if (_preference == null) return null;
    return _preference!.remove(key);
  }
  ...
  static Future<bool>? deleteBool({required String key}) {
    if (_preference == null) return null;
    return _preference!.remove(key);
  }
  ...
  static Future<bool>? deleteDouble({required String key}) {
    if (_preference == null) return null;
    return _preference!.remove(key);
  }
